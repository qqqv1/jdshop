                ...
                <div class="bundle-main">
                    ...
                    <ul class="item-content clearfix">
                      ...
                      <%-- <table cellspacing="1" class="carttable">
                       ...
                       <table width="100%" border="0" cellspacing="0">
                                <c:forEach items="${cart.items }" var="entry">
                                    ...
                                    <tr>
                                        ...
                                        <td width="33%">${entry.value.product.pname }</td>

                                        <td width="14%">${entry.value.product.shopPrice}</td>
                                        <td width="13%">
                                            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                       ...
                       <%-- <li class="td td-item">
                            <div class="item-pic">
                                <a href="javascript:void(0)" target="_blank" data-title="美康粉黛醉美东方唇膏口红正品 持久保湿滋润防水不掉色护唇彩妆" class="J_MakePoint" data-point="tbcart.8.12">
