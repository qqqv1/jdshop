                ...
                <div class="ibox-content">
                    <form class="form-horizontal" id="category" action="javascript:void(0)">
                        <div class="form-group">
                            <label class="col-sm-3 control-label"><span style="color:red;">*</span>父类名称：</label>
                            <div class="col-sm-8">
                                <select id ="parentId" name="parentId" style="width: 100%;font-size: 12px" class="form-control selectpicker">
        ...
        $.ajax({
            ...
            success: function (cats) {
                ...
                $.each(cats, function (i,cat) {
                    $('#parentId').append("<option value=" + cat.cid + ">" + cat.cname + "</option>");
                });
